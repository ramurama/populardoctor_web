...
import { CREATE_DOCTOR, VIEW_DOCTORS, DOCTOR_MANAGEMENT } from '../../../constants/strings';
      ...
      <div className="sidebar__content">
        ...
        <ul className="sidebar__block">
          ...
          <SidebarCategory title={DOCTOR_MANAGEMENT} icon="diamond">
            <SidebarLink title={CREATE_DOCTOR} route={ROUTE_CREATE_DOCTOR} onClick={this.hideSidebar} />
            <SidebarLink title={VIEW_DOCTORS} route={ROUTE_VIEW_DOCTORS} onClick={this.hideSidebar} />
          </SidebarCategory>
        </ul>
      </div>
    );
